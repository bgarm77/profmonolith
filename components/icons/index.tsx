// SVG-иконки из дизайна как React-компоненты (инлайн, без лишних запросов).
...
export function TruckCraneIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...stroke} {...props}>
...
export function FormworkIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...stroke} {...props}>
...
export function NetIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...stroke} {...props}>
      <path d="M4 4l16 16M4 8l12 12M8 4l12 12M4 12l8 8" />
    </svg>
  );
}
...
export function EdgeIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...stroke} {...props}>
      <path d="M3 18h18M6 18V9M12 18V6M18 18v-5" />
    </svg>
  );
}
...
export function StairsIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...stroke} {...props}>
      <path d="M3 21V7l6-4 6 4v14M9 21v-5h6M15 11l6 3v7" />
    </svg>
  );
}

export function DustNetIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" {...stroke} {...props}>
      <path d="M3 6h13M3 12h17M3 18h11" />
